...
import { Form, Link, RedirectFunction} from 'react-router-dom'
            ...
            <div class="max-w-md px-3 rounded-lg mx-auto overflow-hidden mt-4 bg-gray-200">
                ...
                <div class="flex flex-col mt-2 mb-5">
                    ...
                    <div class="relative mb-3"/>
                        ...
                        <p class="text-sm text-rigth font-semibold"> Don't have an accounts <Link to={'/register'} class="text-sm text-rigth font-semibold text-red-500"> Register</Link> nows</p>
                </div>
            </div>
        </form>
        )
