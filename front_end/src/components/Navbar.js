...
export function NavbarDefault() {
  ...
  const navList = (
    <ul className=" text-red-600 mt-2 mb-4 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <Typography
        as="li"
        variant="small"
        color="blue-gray"
    ...
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4">
      <div className="container mx-auto flex items-center justify-between text-blue-gray-900">
        ...
        <div className="flex items-center gap-x-1">
          <Link to={"/login"}><Button variant="text" size="sm" className="hidden lg:inline-block text-red-600">
            <span>Log In</span>
          </Button>
          </Link>
          <Link to="/register">
