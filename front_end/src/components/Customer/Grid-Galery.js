    ...
    <>
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-2 mb-3 ">
        <div className="grid gap-4 relative transform transition-transform hover:scale-105 cursor-pointer">
          ...
          <div className="absolute top-2 left-2 right-0 bottom-0 flex items-left">
            <p className="text-white text-xl font-bold">Da Nang</p>
            <img
        ...
        <div className="grid gap-4 relative  transform transition-transform hover:scale-105 cursor-pointer">
          ...
          />
          <div className="absolute top-2 left-2 right-0 bottom-0 flex items-left">
            <p className="text-white text-xl font-bold">Ho Chi Minh City</p>
            <img
              className="h-4 w-6 mt-2 ml-2"
              src="https://th.bing.com/th/id/OIP.TuKIodlDSsomCsjyM3DTuQHaE7?rs=1&pid=ImgDetMain"
              alt="vietnam-icon"
      ...
      <div className="grid grid-cols-3 gap-4 md:grid-cols-3">
        <div className="relative  transform transition-transform hover:scale-105 cursor-pointer">
          ...
          />
          <div className="absolute top-2 left-2 right-0 bottom-0 flex items-left">
            <p className="text-white text-xl font-bold">Ha Noi</p>
            <img
              className="h-4 w-6 mt-2 ml-2"
              src="https://th.bing.com/th/id/OIP.TuKIodlDSsomCsjyM3DTuQHaE7?rs=1&pid=ImgDetMain"
              alt="vietnam-icon"
        ...
        <div className="relative  transform transition-transform hover:scale-105 cursor-pointer">
          ...
          />
          <div className="absolute top-2 left-2 right-0 bottom-0 flex items-left">
            <p className="text-white text-xl font-bold">Da Lat</p>
            <img
              className="h-4 w-6 mt-2 ml-2"
              src="https://th.bing.com/th/id/OIP.TuKIodlDSsomCsjyM3DTuQHaE7?rs=1&pid=ImgDetMain"
              alt="vietnam-icon"
        ...
        <div className="relative  transform transition-transform hover:scale-105 cursor-pointer">
          ...
          />
          <div className="absolute top-2 left-2 right-0 bottom-0 flex items-left">
            <p className="text-white text-xl font-bold">Khanh Hoa</p>
            <img
              className="h-4 w-6 mt-2 ml-2"
              src="https://th.bing.com/th/id/OIP.TuKIodlDSsomCsjyM3DTuQHaE7?rs=1&pid=ImgDetMain"
              alt="vietnam-icon"
