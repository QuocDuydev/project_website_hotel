...
function CardRoom({ selectedHotelId }) {
  const [rooms, setRooms] = useState([]);

  useEffect(() => {
    // Hàm này sẽ gọi API để lấy danh sách phòng dựa trên selectedHotelId
    ...
    // Gọi hàm để lấy danh sách phòng khi selectedHotelId thay đổi
    fetchRooms();
  }, [selectedHotelId]);
